    ...
    public void getNearLocations() {
        ...
        result.setResultCallback(new ResultCallback<PlaceLikelihoodBuffer>() {
            ...
            public void onResult(PlaceLikelihoodBuffer placeLikelihoods) {
                Log.i(LOG_TAG,  "Near places result success: " + placeLikelihoods.getStatus().isSuccess());
                for (PlaceLikelihood placeLikelihood : placeLikelihoods) {
                    Log.d(LOG_TAG, "Near place: " + placeLikelihood.getPlace().toString());
                }
    ...
    public void getRequestedLocations(String query) {
        ...
        predictions.setResultCallback(new ResultCallback<AutocompletePredictionBuffer>() {
            ...
            public void onResult(AutocompletePredictionBuffer autocompletePredictions) {
                Log.i(LOG_TAG,  "Requested places result success: " + autocompletePredictions.getStatus().isSuccess());
